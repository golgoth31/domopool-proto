...
func (x *Filters) GetState() FilterStates {
	if x != nil {
		return x.State
	}
...
func (x *Filters) GetDuration() uint32 {
	if x != nil {
		return x.Duration
	}
	return 0
...
var file_domopool_proto_rawDesc = []byte{
	...
	0x73, 0x52, 0x05, 0x69, 0x6e, 0x66, 0x6f, 0x73, 0x22, 0x54, 0x0a, 0x07, 0x46, 0x69, 0x6c, 0x74,
	0x65, 0x72, 0x73, 0x12, 0x2d, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x01, 0x20, 0x01,
	...
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2a, 0x2e,
	...
	0x72, 0x74, 0x10, 0x01, 0x12, 0x08, 0x0a, 0x04, 0x73, 0x74, 0x6f, 0x70, 0x10, 0x02, 0x42, 0x34,
...
var file_domopool_proto_goTypes = []interface{}{
	...
	(*Filters)(nil),      // 16: domopool.Filters
}
var file_domopool_proto_depIdxs = []int32{
	...
	0,  // 18: domopool.Filters.state:type_name -> domopool.Filter_states
