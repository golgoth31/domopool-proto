...
type PumpTiming int32

const (
	PumpTiming_nothing  PumpTiming = 0
	PumpTiming_dynamic  PumpTiming = 1
	PumpTiming_half_day PumpTiming = 2
	PumpTiming_full_day PumpTiming = 3
)

// Enum value maps for PumpTiming.
var (
	PumpTiming_name = map[int32]string{
		0: "nothing",
		1: "dynamic",
		2: "half_day",
		3: "full_day",
	}
	PumpTiming_value = map[string]int32{
		"nothing":  0,
		"dynamic":  1,
		"half_day": 2,
		"full_day": 3,
...
func (x PumpTiming) Enum() *PumpTiming {
	p := new(PumpTiming)
	*p = x
	return p
}

func (x PumpTiming) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PumpTiming) Descriptor() protoreflect.EnumDescriptor {
	return file_domopool_proto_enumTypes[0].Descriptor()
}

func (PumpTiming) Type() protoreflect.EnumType {
	return &file_domopool_proto_enumTypes[0]
}

func (x PumpTiming) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PumpTiming.Descriptor instead.
func (PumpTiming) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	RelayNames_all    RelayNames = 3
	RelayNames_light  RelayNames = 4
)
...
func (RelayNames) Descriptor() protoreflect.EnumDescriptor {
	return file_domopool_proto_enumTypes[2].Descriptor()
}

func (RelayNames) Type() protoreflect.EnumType {
	return &file_domopool_proto_enumTypes[2]
}
...
type Temp struct {
	...
	Addr    string `protobuf:"bytes,3,opt,name=addr,proto3" json:"addr,omitempty"` // repeated uint32 addr = 8;
}
...
type Limits struct {
	...
	WpMin uint32  `protobuf:"varint,1,opt,name=wp_min,json=wpMin,proto3" json:"wp_min,omitempty"`
	WpMax uint32  `protobuf:"varint,2,opt,name=wp_max,json=wpMax,proto3" json:"wp_max,omitempty"`
	...
	Wp_0Derive          uint32  `protobuf:"varint,11,opt,name=wp_0_derive,json=wp0Derive,proto3" json:"wp_0_derive,omitempty"`
...
func (x *Limits) GetWp_0Derive() uint32 {
	if x != nil {
		return x.Wp_0Derive
	}
	return 0
...
type AnalogSensor struct {
	...
	Vmin              uint32 `protobuf:"varint,5,opt,name=vmin,proto3" json:"vmin,omitempty"`
	Vmax              uint32 `protobuf:"varint,6,opt,name=vmax,proto3" json:"vmax,omitempty"`
	...
	VAccuracy         uint32 `protobuf:"varint,9,opt,name=v_accuracy,json=vAccuracy,proto3" json:"v_accuracy,omitempty"`
}
...
func (x *AnalogSensor) GetThreshold() uint32 {
	if x != nil {
		return x.Threshold
	}
	return 0
...
func (x *AnalogSensor) GetVmin() uint32 {
	if x != nil {
		return x.Vmin
	}
	return 0
...
func (x *AnalogSensor) GetVmax() uint32 {
	if x != nil {
		return x.Vmax
	}
	return 0
...
func (x *AnalogSensor) GetVAccuracy() uint32 {
	if x != nil {
		return x.VAccuracy
	}
	return 0
...
type Pump struct {
	...
	Timing         PumpTiming `protobuf:"varint,9,opt,name=timing,proto3,enum=domopool.PumpTiming" json:"timing,omitempty"`
}
...
func (x *Pump) GetTiming() PumpTiming {
	if x != nil {
		return x.Timing
	}
	return PumpTiming_nothing
}
...
type Alarms struct {
	...
	Reboot    bool          `protobuf:"varint,14,opt,name=reboot,proto3" json:"reboot,omitempty"`
}
...
type Metrics struct {
	...
	Wp                  uint32  `protobuf:"varint,6,opt,name=wp,proto3" json:"wp,omitempty"`
	WpVolt              uint32  `protobuf:"varint,7,opt,name=wp_volt,json=wpVolt,proto3" json:"wp_volt,omitempty"`
...
func (x *Metrics) GetWpVolt() uint32 {
	if x != nil {
		return x.WpVolt
	}
	return 0
...
type States struct {
	...
	Dynamic       bool `protobuf:"varint,12,opt,name=dynamic,proto3" json:"dynamic,omitempty"`
	HalfDay       bool `protobuf:"varint,13,opt,name=half_day,json=halfDay,proto3" json:"half_day,omitempty"`
	FullDay       bool `protobuf:"varint,14,opt,name=full_day,json=fullDay,proto3" json:"full_day,omitempty"`
}
...
type Versions struct {
	...
	Arduinojson string `protobuf:"bytes,11,opt,name=arduinojson,proto3" json:"arduinojson,omitempty"`
}
...
func (x *Versions) GetArduinojson() string {
	if x != nil {
		return x.Arduinojson
	}
	return ""
}
...
var file_domopool_proto_rawDesc = []byte{
	...
	0x70, 0x5f, 0x6d, 0x69, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x77, 0x70, 0x4d,
	0x69, 0x6e, 0x12, 0x15, 0x0a, 0x06, 0x77, 0x70, 0x5f, 0x6d, 0x61, 0x78, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x05, 0x77, 0x70, 0x4d, 0x61, 0x78, 0x12, 0x15, 0x0a, 0x06, 0x70, 0x68, 0x5f,
	...
	0x28, 0x0d, 0x52, 0x09, 0x77, 0x70, 0x30, 0x44, 0x65, 0x72, 0x69, 0x76, 0x65, 0x12, 0x15, 0x0a,
	...
	0x61, 0x6d, 0x62, 0x4d, 0x69, 0x6e, 0x22, 0x9b, 0x02, 0x0a, 0x0c, 0x41, 0x6e, 0x61, 0x6c, 0x6f,
	...
	0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x04, 0x76, 0x6d, 0x69, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x76,
	0x6d, 0x61, 0x78, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x04, 0x76, 0x6d, 0x61, 0x78, 0x12,
	...
	,
...
var file_domopool_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_domopool_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_domopool_proto_goTypes = []interface{}{
	(PumpTiming)(0),      // 0: domopool.Pump_timing
	(RelayStates)(0),     // 1: domopool.Relay_states
	(RelayNames)(0),      // 2: domopool.Relay_names
	(*NTP)(nil),          // 3: domopool.NTP
	(*Mqtt)(nil),         // 4: domopool.Mqtt
	(*Network)(nil),      // 5: domopool.Network
	(*Temp)(nil),         // 6: domopool.Temp
	(*Limits)(nil),       // 7: domopool.Limits
	(*AnalogSensor)(nil), // 8: domopool.AnalogSensor
	(*Sensors)(nil),      // 9: domopool.Sensors
	(*Global)(nil),       // 10: domopool.Global
	(*Pump)(nil),         // 11: domopool.Pump
	(*Ads115Alarms)(nil), // 12: domopool.Ads115Alarms
	(*MqttAlarms)(nil),   // 13: domopool.MqttAlarms
	(*Alarms)(nil),       // 14: domopool.Alarms
	(*Tests)(nil),        // 15: domopool.Tests
	(*Metrics)(nil),      // 16: domopool.Metrics
	(*States)(nil),       // 17: domopool.States
	(*Versions)(nil),     // 18: domopool.Versions
	(*Infos)(nil),        // 19: domopool.Infos
	(*Config)(nil),       // 20: domopool.Config
	(*Relay)(nil),        // 21: domopool.Relay
}
var file_domopool_proto_depIdxs = []int32{
	4,  // 0: domopool.Network.mqtt:type_name -> domopool.Mqtt
	3,  // 1: domopool.Network.ntp:type_name -> domopool.NTP
	6,  // 2: domopool.Sensors.twin:type_name -> domopool.Temp
	6,  // 3: domopool.Sensors.twout:type_name -> domopool.Temp
	6,  // 4: domopool.Sensors.tamb:type_name -> domopool.Temp
	8,  // 5: domopool.Sensors.ph:type_name -> domopool.AnalogSensor
	8,  // 6: domopool.Sensors.ch:type_name -> domopool.AnalogSensor
	8,  // 7: domopool.Sensors.wp:type_name -> domopool.AnalogSensor
	0,  // 8: domopool.Pump.timing:type_name -> domopool.Pump_timing
	12, // 9: domopool.Alarms.ads1115:type_name -> domopool.Ads115Alarms
	13, // 10: domopool.Alarms.mqtt:type_name -> domopool.MqttAlarms
	18, // 11: domopool.Infos.versions:type_name -> domopool.Versions
	5,  // 12: domopool.Config.network:type_name -> domopool.Network
	9,  // 13: domopool.Config.sensors:type_name -> domopool.Sensors
	10, // 14: domopool.Config.global:type_name -> domopool.Global
	11, // 15: domopool.Config.pump:type_name -> domopool.Pump
	16, // 16: domopool.Config.metrics:type_name -> domopool.Metrics
	17, // 17: domopool.Config.states:type_name -> domopool.States
	14, // 18: domopool.Config.alarms:type_name -> domopool.Alarms
	15, // 19: domopool.Config.tests:type_name -> domopool.Tests
	19, // 20: domopool.Config.infos:type_name -> domopool.Infos
	7,  // 21: domopool.Config.limits:type_name -> domopool.Limits
	1,  // 22: domopool.Relay.state:type_name -> domopool.Relay_states
	2,  // 23: domopool.Relay.relay:type_name -> domopool.Relay_names
