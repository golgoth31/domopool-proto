...
goog.exportSymbol('proto.domopool.Switch', null, global);
 ...
 * @constructor
 */
proto.domopool.Switch = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.domopool.Switch, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.domopool.Switch.displayName = 'proto.domopool.Switch';
}
...
/**
 * optional Ads115Alarms ads1115 = 7;
 * @return {?proto.domopool.Ads115Alarms}
 */
proto.domopool.Alarms.prototype.getAds1115 = function() {
  return /** @type{?proto.domopool.Ads115Alarms} */ (
    jspb.Message.getWrapperField(this, proto.domopool.Ads115Alarms, 7));
};
 ...
 * @return {!Object}
 */
proto.domopool.Switch.prototype.toObject = function(opt_includeInstance) {
  return proto.domopool.Switch.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.domopool.Switch} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.domopool.Switch}
 */
proto.domopool.Switch.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.domopool.Switch;
  return proto.domopool.Switch.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.domopool.Switch} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.domopool.Switch}
 */
proto.domopool.Switch.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.domopool.Switch.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.domopool.Switch.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.domopool.Switch} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
