 ...
 * @constructor
 */
proto.domopool.PumpTime = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.domopool.PumpTime, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.domopool.PumpTime.displayName = 'proto.domopool.PumpTime';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.domopool.PumpTime.prototype.toObject = function(opt_includeInstance) {
  return proto.domopool.PumpTime.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.domopool.PumpTime} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.domopool.PumpTime.toObject = function(includeInstance, msg) {
  var f, obj = {
    dynamic: jspb.Message.getBooleanFieldWithDefault(msg, 1, false),
    midDay: jspb.Message.getBooleanFieldWithDefault(msg, 2, false),
    fullDay: jspb.Message.getBooleanFieldWithDefault(msg, 3, false)
  };
 ...
 */
proto.domopool.PumpTime.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.domopool.PumpTime;
  return proto.domopool.PumpTime.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.domopool.PumpTime} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.domopool.PumpTime}
 */
proto.domopool.PumpTime.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.domopool.PumpTime.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.domopool.PumpTime.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.domopool.PumpTime} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.domopool.PumpTime.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {boolean}
 */
proto.domopool.PumpTime.prototype.getDynamic = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 1, false));
};
...
/**
 * @param {boolean} value
 * @return {!proto.domopool.PumpTime} returns this
 */
proto.domopool.PumpTime.prototype.setDynamic = function(value) {
  return jspb.Message.setProto3BooleanField(this, 1, value);
};


/**
 * optional bool mid_day = 2;
 * @return {boolean}
 */
proto.domopool.PumpTime.prototype.getMidDay = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 2, false));
};
 ...
 * @return {!proto.domopool.PumpTime} returns this
 */
proto.domopool.PumpTime.prototype.setMidDay = function(value) {
  return jspb.Message.setProto3BooleanField(this, 2, value);
};


/**
 * optional bool full_day = 3;
 * @return {boolean}
 */
proto.domopool.PumpTime.prototype.getFullDay = function() {
 ...
 * @return {!proto.domopool.PumpTime} returns this
 */
proto.domopool.PumpTime.prototype.setFullDay = function(value) {
...
proto.domopool.Pump.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    pumpTime: (f = msg.getPumpTime()) && proto.domopool.PumpTime.toObject(includeInstance, f)
  };
...
proto.domopool.Pump.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 8:
      ...
      break;
    case 9:
      var value = new proto.domopool.PumpTime;
      reader.readMessage(value,proto.domopool.PumpTime.deserializeBinaryFromReader);
...
proto.domopool.Pump.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      9,
      f,
      proto.domopool.PumpTime.serializeBinaryToWriter
    );
  }
};
...
proto.domopool.Pump.prototype.getPumpTime = function() {
  return /** @type{?proto.domopool.PumpTime} */ (
    jspb.Message.getWrapperField(this, proto.domopool.PumpTime, 9));
};


/**
 * @param {?proto.domopool.PumpTime|undefined} value
 * @return {!proto.domopool.Pump} returns this
*/
 ...
 * @return {!proto.domopool.Pump} returns this
 */
proto.domopool.Pump.prototype.clearPumpTime = function() {
  return this.setPumpTime(undefined);
};
 ...
 * @return {boolean}
 */
proto.domopool.Pump.prototype.hasPumpTime = function() {
  return jspb.Message.getField(this, 9) != null;
};
...
proto.domopool.MqttAlarms.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    temps: jspb.Message.getBooleanFieldWithDefault(msg, 4, false)
  };
...
/**
 * optional bool temps = 4;
 * @return {boolean}
 */
proto.domopool.MqttAlarms.prototype.getTemps = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 4, false));
};
 ...
 * @return {!proto.domopool.MqttAlarms} returns this
 */
proto.domopool.MqttAlarms.prototype.setTemps = function(value) {
  return jspb.Message.setProto3BooleanField(this, 4, value);
};
...
/**
 * optional bool reboot = 14;
 * @return {boolean}
 */
proto.domopool.Alarms.prototype.getReboot = function() {
