...
proto.domopool.Libs.toObject = function(includeInstance, msg) {
  var f, obj = {
    dallas: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
...
/**
 * optional string dallas = 1;
 * @return {string}
 */
proto.domopool.Libs.prototype.getDallas = function() {
 ...
 */
proto.domopool.Libs.prototype.setDallas = function(value) {
