...
goog.exportSymbol('proto.domopool.Libs', null, global);
 ...
 * @constructor
 */
proto.domopool.Libs = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.domopool.Libs, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.domopool.Libs.displayName = 'proto.domopool.Libs';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.domopool.Libs.prototype.toObject = function(opt_includeInstance) {
  return proto.domopool.Libs.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.domopool.Libs} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.domopool.Libs.toObject = function(includeInstance, msg) {
  var f, obj = {
    dallastemperature: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.domopool.Libs}
 */
proto.domopool.Libs.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.domopool.Libs;
  return proto.domopool.Libs.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.domopool.Libs} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.domopool.Libs}
 */
proto.domopool.Libs.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      var value = /** @type {string} */ (reader.readString());
      msg.setDallastemperature(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.domopool.Libs.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.domopool.Libs.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.domopool.Libs} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.domopool.Libs.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getDallastemperature();
  if (f.length > 0) {
    writer.writeString(
      1,
      f
...
/**
 * optional string dallastemperature = 1;
 * @return {string}
 */
proto.domopool.Libs.prototype.getDallastemperature = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.domopool.Libs} returns this
 */
proto.domopool.Libs.prototype.setDallastemperature = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
...
proto.domopool.Versions.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    libs: (f = msg.getLibs()) && proto.domopool.Libs.toObject(includeInstance, f)
  };
...
proto.domopool.Versions.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 6:
      ...
      break;
    case 7:
      var value = new proto.domopool.Libs;
      reader.readMessage(value,proto.domopool.Libs.deserializeBinaryFromReader);
      msg.setLibs(value);
      break;
    default:
      reader.skipField();
...
proto.domopool.Versions.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      7,
      f,
      proto.domopool.Libs.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional Libs libs = 7;
 * @return {?proto.domopool.Libs}
 */
proto.domopool.Versions.prototype.getLibs = function() {
  return /** @type{?proto.domopool.Libs} */ (
    jspb.Message.getWrapperField(this, proto.domopool.Libs, 7));
};


/**
 * @param {?proto.domopool.Libs|undefined} value
 * @return {!proto.domopool.Versions} returns this
*/
proto.domopool.Versions.prototype.setLibs = function(value) {
  return jspb.Message.setWrapperField(this, 7, value);
};
 ...
 * @return {!proto.domopool.Versions} returns this
 */
proto.domopool.Versions.prototype.clearLibs = function() {
  return this.setLibs(undefined);
};
 ...
 * @return {boolean}
 */
proto.domopool.Versions.prototype.hasLibs = function() {
  return jspb.Message.getField(this, 7) != null;
};
