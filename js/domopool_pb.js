...
/**
 * optional bool waitForConversion = 4;
 * @return {boolean}
 */
...
/**
 * optional uint32 tempResolution = 5;
 * @return {number}
 */
...
/**
 * optional AnalogSensor waterPressure = 8;
 * @return {?proto.domopool.AnalogSensor}
 */
...
/**
 * optional uint32 lcdBacklightDuration = 1;
 * @return {number}
 */
...
/**
 * optional bool displayStartup = 5;
 * @return {boolean}
 */
...
/**
 * optional uint32 forceDuration = 6;
 * @return {number}
 */
...
proto.domopool.Alarms.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    phval: jspb.Message.getFloatingPointFieldWithDefault(msg, 4, 0.0),
...
/**
 * optional float phVal = 4;
 * @return {number}
 */
proto.domopool.Alarms.prototype.getPhval = function() {
 ...
 * @return {!proto.domopool.Alarms} returns this
 */
proto.domopool.Alarms.prototype.setPhval = function(value) {
...
proto.domopool.Metrics.toObject = function(includeInstance, msg) {
  var f, obj = {
    tempambiant: jspb.Message.getFloatingPointFieldWithDefault(msg, 1, 0.0),
    tempwater: jspb.Message.getFloatingPointFieldWithDefault(msg, 2, 0.0),
    savedtempwater: jspb.Message.getFloatingPointFieldWithDefault(msg, 3, 0.0),
    ph: jspb.Message.getFloatingPointFieldWithDefault(msg, 4, 0.0),
...
proto.domopool.Metrics.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      var value = /** @type {number} */ (reader.readFloat());
      msg.setTempambiant(value);
      break;
    case 2:
      var value = /** @type {number} */ (reader.readFloat());
      msg.setTempwater(value);
      break;
    case 3:
      var value = /** @type {number} */ (reader.readFloat());
      msg.setSavedtempwater(value);
      break;
    case 4:
      var value = /** @type {number} */ (reader.readFloat());
      msg.setPh(value);
...
/**
 * optional float tempAmbiant = 1;
 * @return {number}
 */
proto.domopool.Metrics.prototype.getTempambiant = function() {
 ...
 */
proto.domopool.Metrics.prototype.setTempambiant = function(value) {
  return jspb.Message.setProto3FloatField(this, 1, value);
};


/**
 * optional float tempWater = 2;
 * @return {number}
 */
proto.domopool.Metrics.prototype.getTempwater = function() {
  return /** @type {number} */ (jspb.Message.getFloatingPointFieldWithDefault(this, 2, 0.0));
};
 ...
 * @return {!proto.domopool.Metrics} returns this
 */
proto.domopool.Metrics.prototype.setTempwater = function(value) {
  return jspb.Message.setProto3FloatField(this, 2, value);
};


/**
 * optional float savedTempWater = 3;
 * @return {number}
 */
proto.domopool.Metrics.prototype.getSavedtempwater = function() {
  return /** @type {number} */ (jspb.Message.getFloatingPointFieldWithDefault(this, 3, 0.0));
};
 ...
 * @return {!proto.domopool.Metrics} returns this
 */
proto.domopool.Metrics.prototype.setSavedtempwater = function(value) {
  return jspb.Message.setProto3FloatField(this, 3, value);
};
...
/**
 * optional float waterPressure = 6;
 * @return {number}
 */
...
/**
 * optional uint32 over15Duration = 7;
 * @return {number}
 */
