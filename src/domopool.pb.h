...
#define domopool_Versions_init_default           {"", 0, "", "", "", {{NULL}, NULL}}
...
#define domopool_Versions_init_zero              {"", 0, "", "", "", {{NULL}, NULL}}
...
#define domopool_Versions_dallas_tag             7
...
X(a, CALLBACK, SINGULAR, STRING,   dallas,            7)
